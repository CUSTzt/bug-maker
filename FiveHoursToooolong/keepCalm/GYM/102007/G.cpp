...
int main()
{
    ...
    for (int i = 1; i <= n; i++) {
        int l = i - 1;
        int tp1 = num[0] - (pre[0][l + num[0]] - pre[0][l]) + num[1] - (pre[1][l + num[0] + num[1]] - pre[1][l + num[0]]) + num[2] - (pre[2][l + num[0] + num[1] + num[2]] - pre[2][l + num[0] + num[1]]);
        int tp2 = num[0] - (pre[0][l + num[0]] - pre[0][l]) + num[2] - (pre[2][l + num[0] + num[2]] - pre[2][l + num[0]]) + num[1] - (pre[1][l + num[0] + num[2] + num[1]] - pre[1][l + num[0] + num[2]]);
        ans = min({ans, tp1, tp2});
    }
    cout << ans << endl;
    return 0;
