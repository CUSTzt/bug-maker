...
int FUCK(int *a, int *b, int *c, int n1, int n2, int n3) {
    int res = linf;
    FOR(i, 1, 1+n1) {
...
void solve3() {
    ...
    sort(c + 1, c + 1 + n3);
    int zz = linf;
    zz=min(zz,FUCK(c,a,b,n3,n1,n2));
    zz=min(zz,FUCK(a,b,c,n1,n2,n3));
    zz=min(zz,FUCK(b,a,c,n2,n1,n3));
    cout << zz << endl;
}
int32_t main() {
    close;
