...
public class MaxGrade {
    public static void main(String[] args) {
        ...
        String pathString=new String("hdfs://master:9000/inputFile/1805121.txt");//the goal file path
	String pathString1=new String("hdfs://master:9000/inputFile/1805122.txt");
