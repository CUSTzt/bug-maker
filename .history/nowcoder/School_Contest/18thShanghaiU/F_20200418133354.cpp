    ...
    while (1) {
        ...
        if (m == 6) {
            ...
            if (fll == 3 && YUANDAN >= ZCJ) {
                if(day % 10 == 1)printf("Mother's Day: May %dst, %d\n", d, y);
                else if(day % 10 == 2)printf("Mother's Day: May %dnd, %d\n", d, y);
                else if(day % 10 == 3)printf("Mother's Day: May %drd, %d\n", d, y);
                else printf("Mother's Day: May %drd, %d\n", d, y);
