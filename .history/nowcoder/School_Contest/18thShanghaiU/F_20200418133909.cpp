    ...
    while (1) {
        ...
        if (m == 6) {
            ...
            if (fll == 3 && YUANDAN > ZCJ) {
                if(day % 10 == 1)printf("Father's Day: June %dst, %d", d, y);
                else if(day % 10 == 2)printf("Father's Day: June %dnd, %d", d, y);
                else if(day % 10 == 3)printf("Father's Day: June %drd, %d", d, y);
                else printf("Father's Day: May %dth, %d", d, y);
