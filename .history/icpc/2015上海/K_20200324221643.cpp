...
int main() {
    ...
    ———————————————— 版权声明：本文为CSDN博主「紫芝」的原创文章，遵循
            CC 4.0 BY -
        SA 版权协议，转载请附上原文出处链接及本声明。 原文链接：https
        :  // blog.csdn.net/qq_40507857/article/details/82768423char str[maxn];
           ll v[maxn];
    int main() {
        int T;
        int ca = 1;
