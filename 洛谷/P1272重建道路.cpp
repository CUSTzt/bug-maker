...
constexpr int maxn = 200+10; // remember to calculate. if tle, check maxn first.
vi adj[maxn];
int n , p , x, y, vis[maxn], dp[maxn][maxn];
void dfs(int u){
    vis[u] = 1;
    dp[u][1] = adj[u].size();
    dp[u][1] -= (u!=1);
