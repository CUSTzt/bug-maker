...
constexpr int maxn = 202; // remember to calculate. if tle, check maxn first.
constexpr ll MOD = 1e9+7;
ll n , m , k, c[maxn],d[maxn];
struct Mat {
    static const LL M = 202;
    LL v[M][M];
