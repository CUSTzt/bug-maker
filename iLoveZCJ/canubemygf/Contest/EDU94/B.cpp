...
void up() {
    ...
    for (int i = 0; i <= min(cnts, p / s); i++) {
        int num1 = i;
        int num2 = min(cntw, 1ll * (p - num1 * s) / w);
        int num3 = 0, num4 = 0;
        // cout << "num1==="<<num1 << "  num2===" << num2 << endl;
        if (s < w) {
            num3 = max(0ll, min(cnts - num1, f / s));
            int kkp = f - num3 * s;
            num4 = min(kkp / w, cntw - num2);
        }else{
            // cout << "fk \n";
            // cout << "111   " <<  cntw - num2 << endl;
            // cout << "222   " << f/w << endl;
            num4 = max(0ll, min(cntw - num2, f / w));
            int kkp = f - num4 * w;
            num3 = min(kkp / s, cnts - num1);
        }
        // cout << "num1==="<<num1 << "  num2===" << num2 << "  num3==" << num3 << "  num4 == " << num4 << endl;
        umax(ans, num1+num2+num3+num4);
    }
    cout << ans << endl;
}
int32_t main() {
